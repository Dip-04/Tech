...
function Contact() {
  return (
    <>
      ...
      <div className="container mt-5 mb-5" style={{maxWidth:'1152px'}}>
  ...
  <div className="col-md-12">
    <button type="submit" className="btn text-light" style={{ backgroundColor: 'rgba(76, 175, 79, 1)' }}>Submit <i className="bi bi-arrow-right"></i></button>
      ...
      <div className="mt-5 container" style={{maxWidth:'1152px',maxHeight:'720px'}}>
        <iframe
          ...
          style={{ width: '100%', height: '520px', borderRadius: '24px' }}
